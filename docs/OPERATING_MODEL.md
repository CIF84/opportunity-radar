...
| `output/credential_evidence_validation/*/aggregate_summary.json` | EXPERIMENT RESULT, sanitized | Track only population/sample aggregates, fingerprints, source-currentness aggregate, limitations, and zero-call/read-only proof; never include vacancy text, identity, or human notes |
